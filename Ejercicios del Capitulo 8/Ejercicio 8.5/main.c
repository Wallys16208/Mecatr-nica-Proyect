...
void main(void)
{
    ...
    variables de tipo estructura alumno reciben valores, ingresamos los valores ➥de los campos de tres formas diferentes. Los campos de a1 reciben valores
    directamente, los campos de a2 se leen en el programa principal, y los campos ➥de a3 reciben valores a través de una función. */
    printf("Alumno 2\n");
    ...
    puts(a3.personales.correo); /*ı Escribe basura. */
}
